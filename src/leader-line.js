...
var LeaderLine = (function () {
  ...
  function updatePosition(props) {
    ...
    anchorBBoxSE = [0, 1].map(function (i) {
      ...
      curStats.capsMaskAnchor_pathDataSE[i] =
        isAttach !== false && attachProps.conf.customGetPathData
          ? attachProps.conf.customGetPathData(attachProps, props, strokeWidth)
  ...
  function updatePath(props) {
    ...
    if (pathList) {
      ...
      if (pathDataHasChanged(curPathData, aplStats.path_pathData)) {
        ...
        props.linePath.customSetPathData(curPathData);
        ...
        [0, 1].forEach(function (i) {
          ...
          if (curStats.capsMaskAnchor_enabledSE[i]) {
            ...
            if (
              ...
              props.capsMaskAnchorSE[i].customSetPathData(curPathData);
   ...
   * @property {Function} [customGetPathData] - function(attachProps, props, strokeWidth) type:anchor
  ...
  ATTACHMENTS = {
    ...
    areaAnchor: {
      ...
      customGetPathData: function (attachProps, props) {
        var bBox = getBBoxNest(attachProps.element, props.baseWindow);
      ...
      update: function (attachProps) {
        ...
        if (
          ...
          attachProps.path.customSetPathData(value);
    ...
    pathLabel: {
      ...
      init: function (attachProps, attachOptions) {
        ...
        attachProps.updatePath = function (props) {
          ...
          curStats.pathData = value =
            ATTACHMENTS.pathLabel.getOffcustomSetPathData(
              pathList,
          ...
          if (pathDataHasChanged(value, aplStats.pathData)) {
            traceLog.add("pathData"); // [DEBUG/]
            attachProps.elmPath.customSetPathData(value);
            aplStats.pathData = value;
      ...
      getOffcustomSetPathData: function (pathList, offsetLen, cornerMargin) {
        var STEP_LEN = 16,
          TOLERANCE = 3,
          parts = [],
          lastLineSeg,
      ...
      initSvg: function (attachProps, props) {
        ...
        text.elmPath.customSetPathData([
          { type: "M", values: [0, 100] },
          { type: "h", values: [100] },
        ]);
