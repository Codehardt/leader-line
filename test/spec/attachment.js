...
describe("attachment", function () {
  ...
  function loadBefore(beforeDone) {
    ...
    loadPage(
      "spec/common/page.html",
      function (frmWindow, frmDocument, body, done) {
        TOLERANCE = frmWindow.IS_WEBKIT
          ? 10
          : frmWindow.IS_GECKO || frmWindow.IS_TRIDENT
          ? 5
          : 1;
  ...
  describe("life cycle", function () {
    ...
    it(registerTitle("bind-unbind-remove"), function (done) {
      ...
      atc1 = window.LeaderLine.pointAnchor({
        element: document.getElementById("elm1"),
      });
      atc2 = window.LeaderLine.pointAnchor({
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            ...
            setTimeout(function () {
              expect(
                traceLog.getTaggedLog("LeaderLineAttachment.remove.delayedProc")
              ).toEqual([]);
              expect(
                traceLog.getTaggedLog("ATTACHMENTS.pointAnchor.removeOption")
              ).toEqual(["optionName=start", "optionName=start"]);
              expect(traceLog.getTaggedLog("removeAttachment")).toEqual([
                "not-found",
              ]); // 2nd ll try to remove
              expect(props1.attachments.length).toBe(0);
              expect(props2.attachments.length).toBe(0);
              expect(atc1.isRemoved).toBe(true);
              expect(ll.start).toBe(document.getElementById("elm1"));
    ...
    it(registerTitle("flow"), function (done) {
      ...
      traceLog.clear();
      atc1 = window.LeaderLine.areaAnchor({
        element: document.getElementById("elm1"),
      });
      expect(traceLog.log).toEqual([
        "<ATTACHMENTS.areaAnchor.init>",
        "</ATTACHMENTS.areaAnchor.init>",
      ]);
      atc2 = window.LeaderLine.areaAnchor({
        element: document.getElementById("elm2"),
      });
      attachProps1 = window.insAttachProps[atc1._id];
      attachProps2 = window.insAttachProps[atc2._id];
      ...
      expect(traceLog.log).toEqual([
        ...
        "capsMaskAnchor_strokeWidthSE[0]=4",
        "</updateMask>",
        "<update>",
        "updated.position",
        "updated.path",
      ...
      setTimeout(function () {
        expect(traceLog.log).toEqual([
          ...
          "lineMask_x",
          "capsMaskAnchor_pathDataSE[0]",
          "capsMaskAnchor_strokeWidthSE[0]=0",
          "</updateMask>",
          "<update>",
          "updated.position",
          "updated.path",
          ...
          "</update>",
          "<execDelayedProcs>",
          "<ATTACHMENTS.areaAnchor.updateColor>",
          "color=coral",
          "</ATTACHMENTS.areaAnchor.updateColor>",
          "<svgShow>",
          "</svgShow>",
          "<removeAttachment>",
          "<ATTACHMENTS.areaAnchor.remove>",
          "</ATTACHMENTS.areaAnchor.remove>",
          "</removeAttachment>",
          "</execDelayedProcs>",
          /* eslint-enable indent */
          ...
          setTimeout(function () {
            ...
            setTimeout(function () {
              expect(traceLog.log).toEqual([
                ...
                "not-found",
                "</removeAttachment>",
                "<LeaderLineAttachment.remove.delayedProc>",
                "</LeaderLineAttachment.remove.delayedProc>",
                "</execDelayedProcs>",
                /* eslint-enable indent */
              ]);
  ...
  describe("ATTACHMENTS anchor", function () {
    ...
    it(registerTitle("pointAnchor"), function (done) {
      ...
      atc = window.LeaderLine.pointAnchor({
        element: document
          ...
          .contentDocument.getElementById("elm2"),
        x: 5,
        y: 6,
      });
      ll.start = atc;
    ...
    it(registerTitle("areaAnchor-attachOptions"), function (done) {
      ...
      // elm1 (1, 2) w:100 h:30
      expect(
        Math.abs(props.curStats.position_socketXYSE[0].x - 106)
      ).toBeLessThan(TOLERANCE);
      expect(props.curStats.position_socketXYSE[0].y).toBe(17);
      expect(
        matchPathData(props.curStats.capsMaskAnchor_pathDataSE[0], [
      ...
      expect(attachProps.path.style.strokeDasharray.replace(/\s|px/g, "")).toBe(
        len + "," + gap
      );
    ...
    it(registerTitle("areaAnchor-event auto 2 ll"), function (done) {
      ...
      attachProps = window.insAttachProps[atc._id];
      ll2 = new window.LeaderLine(atc, document.getElementById("elm2"), {
        color: "red",
        size: 8,
      }); // #1
      props2 = window.insProps[ll2._id];
    ...
    it(registerTitle("areaAnchor-event sync"), function (done) {
      ...
      ll2 = new window.LeaderLine(document.getElementById("elm4"), atc, {
        endSocket: "bottom",
      });
      props2 = window.insProps[ll2._id];
      ll.end = atc;
      setTimeout(function () {
        ...
        expect(props.curStats.position_socketXYSE[1].y).toBe(
          rect.top + rect.height / 2
        );
        expect(props2.curStats.position_socketXYSE[1].x).toBe(
        ...
        setTimeout(function () {
          ...
          expect(props2.curStats.position_socketXYSE[1].y).toBe(
            rect.bottom + 7
          );
    ...
    it(registerTitle("areaAnchor-rect"), function (done) {
      ...
      expect(props.curStats.capsMaskAnchor_strokeWidthSE[0]).toBe(0);
      expect(props.curStats.position_socketXYSE[0].x).toBe(
        rect.left + rect.width / 2
      ); // bottom
      ...
      expect(props.curStats.position_socketXYSE[0].y).toBe(
        rect.top + rect.height / 2
      );
      ...
      expect(props.curStats.capsMaskAnchor_pathDataSE[0]).toEqual([
        { type: "M", values: [rect.left - padding, rect.top + offset] },
        {
          ...
          values: [
            rect.left - padding,
            rect.top + offset - r * CIRCLE_CP,
            rect.left + offset - r * CIRCLE_CP,
            rect.top - padding,
            rect.left + offset,
            rect.top - padding,
          ],
        ...
        { type: "L", values: [rect.right + padding, rect.bottom - offset] },
        {
          ...
          values: [
            rect.right + padding,
            rect.bottom - offset + r * CIRCLE_CP,
            rect.right - offset + r * CIRCLE_CP,
            rect.bottom + padding,
            rect.right - offset,
            rect.bottom + padding,
      ...
      expect(
        Math.abs(
          props.curStats.position_socketXYSE[0].y - (rect.top + rect.height / 2)
        )
      ).toBeLessThan(TOLERANCE);
    ...
    it(registerTitle("areaAnchor-circle"), function (done) {
      ...
      expect(props.curStats.capsMaskAnchor_pathDataSE[0]).toEqual([
        { type: "M", values: [rect.left - paddingX, rect.top + offsetY] },
        {
          ...
          values: [
            rect.left - paddingX,
            rect.top + offsetY - ry * CIRCLE_CP,
            rect.left + offsetX - rx * CIRCLE_CP,
            rect.top - paddingY,
            rect.left + offsetX,
            rect.top - paddingY,
          ],
        },
        {
          type: "C",
          values: [
            rect.right - offsetX + rx * CIRCLE_CP,
            rect.top - paddingY,
            rect.right + paddingX,
            rect.top + offsetY - ry * CIRCLE_CP,
            rect.right + paddingX,
        ...
        },
        {
          ...
          values: [
            rect.right + paddingX,
            rect.bottom - offsetY + ry * CIRCLE_CP,
            rect.right - offsetX + rx * CIRCLE_CP,
    ...
    it(registerTitle("mouseHoverAnchor"), function (done) {
      ...
      // no-inline via class
      atc = window.LeaderLine.mouseHoverAnchor({
        element: document.getElementById("span-b"),
      });
      attachProps = window.insAttachProps[atc._id];
      ll.start = atc;
      ...
      atc = window.LeaderLine.mouseHoverAnchor({
        element: document.getElementById("span-c"),
      });
      attachProps = window.insAttachProps[atc._id];
      ll.start = atc;
      expect(attachProps.style.display == null).toBe(true);
      // no-inline in native
      atc = window.LeaderLine.mouseHoverAnchor({
        element: document.getElementById("h3-a"),
      });
      attachProps = window.insAttachProps[atc._id];
      ll.start = atc;
      expect(attachProps.style.display == null).toBe(true);
      // inline via class
      atc = window.LeaderLine.mouseHoverAnchor({
        element: document.getElementById("h3-b"),
      });
      attachProps = window.insAttachProps[atc._id];
      ll.start = atc;
      expect(attachProps.style.display).toBe("inline-block");
      ...
      atc = window.LeaderLine.mouseHoverAnchor({
        element: document.getElementById("h3-c"),
      });
      attachProps = window.insAttachProps[atc._id];
      ll.start = atc;
      expect(attachProps.style.display).toBe("inline-block");
      ...
      // padding:0 in native
      atc = window.LeaderLine.mouseHoverAnchor({
        element: document.getElementById("span-d"),
      });
      attachProps = window.insAttachProps[atc._id];
      ll.start = atc;
      ...
      atc = window.LeaderLine.mouseHoverAnchor({
        element: document.getElementById("span-e"),
      });
      attachProps = window.insAttachProps[atc._id];
      ll.start = atc;
      ...
      atc = window.LeaderLine.mouseHoverAnchor({
        element: document.getElementById("span-f"),
      });
      attachProps = window.insAttachProps[atc._id];
      ll.start = atc;
      expect(attachProps.style.paddingTop == null).toBe(true);
      ...
      // padding:2 via class
      atc = window.LeaderLine.mouseHoverAnchor({
        element: document.getElementById("span-g"),
      });
      attachProps = window.insAttachProps[atc._id];
      ll.start = atc;
      expect(attachProps.style.paddingTop == null).toBe(true);
      ...
      atc = window.LeaderLine.mouseHoverAnchor({
        element: document.getElementById("span-h"),
      });
      attachProps = window.insAttachProps[atc._id];
      ll.start = atc;
      expect(attachProps.style.paddingTop == null).toBe(true);
      ...
      atc = window.LeaderLine.mouseHoverAnchor({
        element: document.getElementById("height1"),
      });
      attachProps = window.insAttachProps[atc._id];
      ll.start = atc;
      expect(attachProps.style.paddingTop).toBe(1 + "px");
      ...
      atc = window.LeaderLine.mouseHoverAnchor({
        element: document.getElementById("height2"),
      });
      attachProps = window.insAttachProps[atc._id];
      ll.start = atc;
      expect(attachProps.style.paddingTop).toBe(1 + "px");
      ...
      expect(attachProps.style.backgroundPosition).toBe(
        bBox.width -
          12 /* backgroundSize.width */ -
          2 /* backgroundPosition.right */ +
          "px " +
          2 /* backgroundPosition.top */ +
          "px"
      );
      // padding:60 via class
      atc = window.LeaderLine.mouseHoverAnchor({
      ...
      // SVG
      expect(
        Object.prototype.toString.apply(document.getElementById("rect1"))
      ).toBe("[object SVGRectElement]");
      expect(function () {
        atc = window.LeaderLine.mouseHoverAnchor({
      ...
      expect(
        color === "#f8f881" || color.replace(/\s/g, "") === "rgb(248,248,129)"
      ).toBe(true); // default
      (function () {
        // Event
        var evt = document.createEvent("MouseEvents");
        evt.initMouseEvent(
          "onmouseenter" in element ? "mouseenter" : "mouseover",
          true,
          true,
          window,
          1,
      ...
      setTimeout(function () {
        ...
        color = element.style.backgroundColor;
        expect(
          color === "#fadf8f" || color.replace(/\s/g, "") === "rgb(250,223,143)"
        ).toBe(true); // hover
        (function () {
          // Event
          var evt = document.createEvent("MouseEvents");
          evt.initMouseEvent(
            "onmouseleave" in element ? "mouseleave" : "mouseout",
            true,
            true,
            window,
            1,
        ...
        setTimeout(function () {
          ...
          expect(
            color === "#f8f881" ||
              color.replace(/\s/g, "") === "rgb(248,248,129)"
          ).toBe(true); // default
  ...
  describe("ATTACHMENTS.captionLabel", function () {
    ...
    it(registerTitle("event auto color"), function (done) {
      ...
      expect(traceLog.log).toEqual(
        [
          ...
          "<updateLine>",
          "line_color=red",
          "<ATTACHMENTS.captionLabel.updateColor>",
          "color=red",
          "</ATTACHMENTS.captionLabel.updateColor>",
          "</updateLine>",
          "<updatePlug>",
        ...
        [
          ...
          .concat(
            [
              ...
              .concat(
                [
                  "<ATTACHMENTS.captionLabel.updateShow>",
                  "on=true",
                  "</ATTACHMENTS.captionLabel.updateShow>",
                  "</ATTACHMENTS.captionLabel.initSvg>",
                  "</ATTACHMENTS.captionLabel.bind>",
    ...
    it(registerTitle("updateSocketXY"), function (done) {
      ...
      // socket: right (101, 17)
      expect(
        Math.abs(attachProps.elmPosition.x.baseVal.getItem(0).value) - (101 + 3)
      ).toBeLessThan(TOLERANCE);
      expect(
        Math.abs(attachProps.elmPosition.y.baseVal.getItem(0).value) -
          (17 - 4 + height)
      ).toBeLessThan(TOLERANCE);
      ...
      // socket: left (216, 247)
      expect(
        Math.abs(attachProps.elmPosition.x.baseVal.getItem(0).value) - (216 + 3)
      ).toBeLessThan(TOLERANCE);
      expect(
        Math.abs(attachProps.elmPosition.y.baseVal.getItem(0).value) -
          (247 - 4 + height)
      ...
      // socket: left (300, 315)
      expect(
        Math.abs(attachProps.elmPosition.x.baseVal.getItem(0).value) -
          (300 - width - height / 2)
      ).toBeLessThan(TOLERANCE);
      expect(
        Math.abs(attachProps.elmPosition.y.baseVal.getItem(0).value) -
          (315 + sideLen + height / 2 + height)
      ).toBeLessThan(TOLERANCE);
    ...
    it(registerTitle("updatePath"), function (done) {
      ...
      pointLen =
        window.getCubicLength(points[0], points[1], points[2], points[3]) / 2;
      point = window.getPointOnCubic(
        points[0],
        points[1],
        points[2],
        points[3],
      ...
      expect(
        Math.abs(
          attachProps.elmPosition.x.baseVal.getItem(0).value -
            (point.x - width / 2)
        )
      ).toBeLessThan(TOLERANCE);
      expect(
  ...
  describe("ATTACHMENTS.pathLabel", function () {
    ...
    it(registerTitle("event auto color"), function (done) {
      ...
      expect(traceLog.log).toEqual(
        [
          ...
          "<updateLine>",
          "line_color=red",
          "<ATTACHMENTS.pathLabel.updateColor>",
          "color=red",
          "</ATTACHMENTS.pathLabel.updateColor>",
          "</updateLine>",
          "<updatePlug>",
          ...
          .concat(
            window.IS_WEBKIT
              ? [
                  "<ATTACHMENTS.pathLabel.adjustEdge>",
                  "</ATTACHMENTS.pathLabel.adjustEdge>",
                ]
              : []
          )
        ...
        [
          ...
          .concat(
            [
              ...
              .concat(
                [
                  "<ATTACHMENTS.pathLabel.updateShow>",
                  "on=true",
                  "</ATTACHMENTS.pathLabel.updateShow>",
                  "</ATTACHMENTS.pathLabel.initSvg>",
                  "</ATTACHMENTS.pathLabel.bind>",
    ...
    it(registerTitle("updatePath"), function (done) {
      ...
      expect(
        matchPathData(
          attachProps.elmPath.customGetPathData(),
          /* eslint-disable */
          [
            { type: "M", values: [99, 10] },
            { type: "L", values: [113.45790540711569, 12.588993479995715] },
            { type: "L", values: [125.00367009929991, 20.052521291856852] },
            { type: "L", values: [133.25392274031714, 31.10649327917713] },
            { type: "L", values: [138.86195583820046, 44.63620486761069] },
            { type: "L", values: [142.6194913389643, 60.12119820877575] },
            { type: "L", values: [145.11025096028396, 77.19164735965228] },
            { type: "L", values: [146.79443584936524, 95.450767445376] },
            { type: "L", values: [148.08134035790187, 114.46006326276132] },
            { type: "L", values: [149.3586991910288, 133.7502464183206] },
            { type: "L", values: [151.001808544847, 152.82907696175036] },
            { type: "L", values: [153.3728781429567, 171.18425484673858] },
            { type: "L", values: [156.81219871199187, 188.28417155251176] },
            { type: "L", values: [161.61856547609653, 203.5845027988012] },
            { type: "L", values: [168.02223388301437, 216.56396932825058] },
            { type: "L", values: [176.19964066022627, 226.82867707972056] },
            { type: "L", values: [186.45991976322395, 234.2244985862475] },
            { type: "L", values: [199.50078379254754, 238.6383814624575] },
      ...
      expect(
        matchPathData(
          ...
          [
            { type: "M", values: [93, 4] },
            { type: "L", values: [114.20947945953301, 6.091423069232938] },
            { type: "L", values: [131.4698555031056, 12.698358169234679] },
            { type: "L", values: [144.2742615692582, 24.025871063915208] },
            { type: "L", values: [151.69058015937972, 38.54878855107664] },
            { type: "L", values: [154.5150200830456, 54.34728990721647] },
            { type: "L", values: [154.23995252679438, 70.8017858058205] },
            { type: "L", values: [151.94761169050295, 87.83353142273594] },
            { type: "L", values: [148.4120312831293, 105.32027984679462] },
            { type: "L", values: [144.2918935965981, 123.0204322875196] },
            { type: "L", values: [140.20756530254704, 140.6014680872292] },
            { type: "L", values: [136.76022144758608, 157.65978578393887] },
            { type: "L", values: [134.5214672282143, 173.72243037601524] },
            { type: "L", values: [133.989315888415, 188.2441522690337] },
            { type: "L", values: [135.49386613813357, 200.65598171667304] },
            { type: "L", values: [139.12753673013012, 210.6205843911355] },
            { type: "L", values: [145.11116347950176, 218.48160745957898] },
            { type: "L", values: [154.5907322007727, 224.91467179259445] },
            { type: "L", values: [169.21196232512074, 229.748974040884] },
            { type: "L", values: [184.95666727010772, 231.85696552796642] },
          ]
          /* eslint-enable */
        )
      ).toBe(true);
      ...
      expect(
        matchPathData(
          ...
          [
            { type: "M", values: [99, 10] },
            { type: "L", values: [112.63313145373253, 11.777157240055438] },
            { type: "L", values: [124.96758856721615, 16.883111088721456] },
            { type: "L", values: [135.8701099374102, 24.819455428886144] },
            { type: "L", values: [145.45648368405125, 35.08569167070432] },
            { type: "L", values: [153.95656947272747, 47.30861796828751] },
            { type: "L", values: [161.5934043875896, 61.20656329575481] },
            { type: "L", values: [168.553025058285, 76.53218509749871] },
            { type: "L", values: [174.99140641337257, 93.04373896691506] },
            { type: "L", values: [181.0456029600108, 110.49564669477604] },
            { type: "L", values: [186.84148125772245, 128.63667103031895] },
            { type: "L", values: [192.49817850255434, 147.21031450669147] },
            { type: "L", values: [198.13044770894624, 165.9555637180103] },
            { type: "L", values: [203.84970371122546, 184.60743378311733] },
            { type: "L", values: [209.76417474123423, 202.8972078972368] },
            { type: "L", values: [215.97825997006294, 220.55242160285275] },
            { type: "L", values: [222.59095208694544, 237.29677367411068] },
            { type: "L", values: [229.69298128308986, 252.85044500920839] },
            { type: "L", values: [237.36230914444823, 266.93205451610976] },
            { type: "L", values: [245.65841939400428, 279.26508260587866] },
            { type: "L", values: [254.6195457123344, 289.59384523931516] },
            { type: "L", values: [264.276656698847, 297.7124886901758] },
            { type: "L", values: [274.7069317102511, 303.4901311490579] },
            { type: "L", values: [286.11458837386164, 306.8350179222061] },
      ...
      expect(
        matchPathData(
          ...
          [
            ...
            { type: "L", values: [301.32980584165017, 304.4533599462429] },
          ]
          /* eslint-enable */
        )
      ).toBe(true);
      ...
      expect(
        matchPathData(
          ...
          [
            { type: "M", values: [99, 10] },
            { type: "L", values: [207.5, 10] },
            { type: "L", values: [207.5, 308] },
            { type: "M", values: [227.5, 308] },
            { type: "L", values: [292, 308] },
          ]
          /* eslint-enable */
        )
      ).toBe(true);
      ...
      strokeWidth = 4;
      expect(
        Math.abs(attachProps.elmPath.customGetPathData()[0].values[1]) - // y of start point
          (props.linePath.customGetPathData()[0].values[1] -
      ...
      expect(
        matchPathData(
          ...
          [
            { type: "M", values: [93, 4] },
            { type: "L", values: [213.5, 4] },
            { type: "L", values: [213.5, 302] },
            { type: "M", values: [233.5, 302] },
            { type: "L", values: [268, 302] },
          ]
          /* eslint-enable */
        )
      ).toBe(true);
      ...
      expect(
        matchPathData(
          ...
          /* eslint-disable */
          [
            { type: "M", values: [93, 5.5] },
            { type: "L", values: [212, 5.5] },
            { type: "L", values: [212, 303.5] },
            { type: "M", values: [224.5, 303.5] },
            { type: "L", values: [268, 303.5] },
          ]
          /* eslint-enable */
        )
      ).toBe(true);
    ...
    it(registerTitle("startOffset"), function (done) {
      ...
      ll.endLabel = atc1;
      ll.middleLabel = atc2;
      lenAll = window.getAllPathDataLen(
        attachProps0.elmPath.customGetPathData()
      );
      ...
      expect(
        Math.abs(
          attachProps0.elmOffset.startOffset.baseVal.value -
      ...
      expect(
        Math.abs(
          attachProps1.elmOffset.startOffset.baseVal.value -
      ...
      // 50%
      expect(
        Math.abs(attachProps2.elmOffset.startOffset.baseVal.unitType)
      ).toBe(SVGLength.SVG_LENGTHTYPE_PERCENTAGE);
      expect(
        Math.abs(
          attachProps2.elmOffset.startOffset.baseVal.valueInSpecifiedUnits
        )
      ).toBe(50);
      ...
      atc0 = window.LeaderLine.pathLabel({
        text: "label-0",
        fontSize: "10px",
        lineOffset: -4,
      });
      atc1 = window.LeaderLine.pathLabel({
        text: "label-1",
        fontSize: "10px",
        lineOffset: 8,
      });
      atc2 = window.LeaderLine.pathLabel({
        text: "label-2",
        fontSize: "10px",
        lineOffset: 16,
      });
      ...
      expect(
        Math.abs(
          attachProps1.elmOffset.startOffset.baseVal.value -
            // plug: plugBackLen + attachProps.strokeWidth / 2 + fontSize / 4
            (lenAll -
              ((24 * 8) / 4 /* DEFAULT_OPTIONS.lineSize */ +
                attachProps1.strokeWidth / 2 +
                fontSize / 4) +
              8)
        )
      ).toBeLessThan(TOLERANCE);
      expect(
        Math.abs(
          attachProps2.elmOffset.startOffset.baseVal.value -
            // half
            (lenAll / 2 + 16)
        )
      ).toBeLessThan(TOLERANCE);
