...
(function () {
    ...
    testCasesSrc = [
      ...
      },
      {
        ...
        socketXYSE: [
          { x: 50, y: 210, socketId: SOCKET_RIGHT },
          {
            x: 50 + MIN_GRID_LEN + 15,
            y: 210 + MIN_GRID_LEN - 15,
            socketId: SOCKET_TOP,
          },
        ],
      },
  ...
  function cases() {
    ...
    testCasesSrc.forEach(function (testCase, i) {
      ...
      path.customSetPathData(data.pathData);
      ...
      tdExpected.appendChild(
        parser.parseFromString(testCasesSvg[i], "image/svg+xml").documentElement
      );

      testCases.push({
        title: testCase.title,
        args: {
          socketXYSE: testCase.socketXYSE,
          socketGravitySE: testCase.socketGravitySE,
        },
    ...
    document.getElementById("testCasesSvg-json").value =
      JSON.stringify(newTestCasesSvg);
  }
